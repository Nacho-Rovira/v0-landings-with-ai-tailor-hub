...
export default function FintechProposalPage() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      // Switch to scrolling variant after scrolling 100px
      if (window.scrollY > 100) {
        setHeaderVariant("scrolling")
      } else {
        setHeaderVariant("starter")
      }
    }
  ...
  return (
    ...
    >
      ...
      <div style={{ paddingTop: headerVariant === "scrolling" ? "49px" : "201px" }}>
        {/* Main Content */}
        <main
          style={{
            flex: 1,
